    ...
    bosses: {
      broodmother: {
        ...
        unlocks: [
          ...
          { name: 'Tek Foundation', gamma: true, beta: true, alpha: true },
          { name: 'Tek Triangle Foundation', gamma: true, beta: true, alpha: true },
          { name: 'Tek Triangle Roof / Corner', gamma: true, beta: true, alpha: true },
          { name: 'Tek Quarter / Triangle Ceiling', gamma: true, beta: true, alpha: true },
          { name: 'Tek Pillar', gamma: false, beta: true, alpha: true },
          { name: 'Tek Wall / Doorway / Window', gamma: false, beta: true, alpha: true },
          { name: 'Tek Ceiling / Hatchframe', gamma: false, beta: true, alpha: true },
          { name: 'Tek Quarter Wall / Railing', gamma: false, beta: true, alpha: true },
          { name: 'Tek Sloped Wall', gamma: false, beta: false, alpha: true },
          { name: 'Tek Ladder', gamma: false, beta: false, alpha: true },
          { name: 'Tek Boots', gamma: false, beta: false, alpha: true },
          { name: 'Tek Turret', gamma: false, beta: false, alpha: true },
          { name: 'Tek Helmet', gamma: false, beta: false, alpha: true }
        ]
      },
